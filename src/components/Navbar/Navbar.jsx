    ...
    return (
        <header>
            <nav className="flex justify-between w-full py-4">
                <p onClick={() => location.reload()} className="flex items-center gap-4 text-2xl hover:cursor-pointer text-blackDarker dark:text-white"><Icon className="p-3 text-6xl text-white rounded-full bg-vermilion" icon="gala:book" inline={true} />Dictionary</p>
